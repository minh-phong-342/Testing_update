                    ...
                    <div class="jumbotron">
						...
						<div class="panel-body">
							...
							{	
								...
								{
									echo '<script>alert("Sending") </script>' ;		
								}
										...
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==1 )
											{
												echo"<tr class='gradeC'>
													...
													<td>".$row['email']."</td>
													<td>".$row['cdate']."</td>
													<td>".$row['approval']."</td><td><a href=newsletter.php?eid=".$id ." <button class='btn btn-primary'> <i class='fa fa-edit' ></i>";
											...
											else
											{
												echo"<tr class='gradeU'>
													...
													<td>".$row['cdate']."</td>
													<td>".$row['approval']."</td>
													<td><a href=newsletter.php?eid=".$id." <button class='btn btn-primary'> <i class='fa fa-edit' ></i> ";
                                                    if($row['approval'] == 'Allowed')
                                                        echo "Not Permission";
                                                    else
                                                        echo "Permission";
