						...
						<form name="form" method="post">
							...
							<?php
							 ...
							 if(isset($_POST['add']))
							 {
										...
										$check="SELECT `id`,`typee`,`bedding` FROM room WHERE typee = '$room' AND bedding = '$bed'";
										...
										if($data==NULL) 
                                        {
										    ...
										    $sql ="INSERT INTO `room`( `typee`, `bedding`,`place`) VALUES ('$room','$bed','$place')" ;
